...
const getApprovedPackagesClarificationNeed = (props) => {
  ...
  return axiosRequest({
    url: `${APPROVED_PACKAGES_URL}/v1/approved-packages/clarification-need${params}`
  })
}
...
const getApprovedPackagesPackageTypes = () => axiosRequest({
  url: `${APPROVED_PACKAGES_URL}/package-types`
})

const getApprovedPackagesSocialWorkers = () => axiosRequest({
  url: `${APPROVED_PACKAGES_URL}/social-workers`
})

const getApprovedPackagesApprovers = () => axiosRequest({
