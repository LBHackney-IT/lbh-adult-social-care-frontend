            ...
            <h1 className="lbh-header__title">
              <Link href={BROKER_PORTAL_ROUTE}>
                <a className="lbh-header__title-link">
                  ...
                  <span className="lbh-header__service-name">{getSlot(nodeList, 'service-name')}</span>
                  <span className={`lbh-header__service-name${shortServiceNodeList}`}>
                    {getSlot(nodeList, 'short-name')}
                  </span>
                </a>
              </Link>
            </h1>
