...
const PackageInfo = ({ headerTitle, items, containerId, details }) => {
  ...
  return (
    <Container className="package-details__items-container">
      ...
      {items?.map(({
        ...
        return (
          <Container className="package-details__items" key={id}>
            <Container className="package-details__items-date" display="flex" justifyContent="space-between">
              <p>
            ...
            {title && <p className="package-details__items-title font-weight-bold">{title}</p>}
            {address &&
            <Container>
              <p className="package-details__items-place">{place} {id}</p>
              <p className="package-details__items-address">{address}</p>
            </Container>
            }
            {serviceUserNeed && (
              <SingleAccordion
