...
const SupplierReturnDashboardTable = ({
  ...
  return (
    <div className={`table ${classes}`}>
      <SupplierReturnsDashboardSortTable
        ...
        return (
          ...
          >
            ...
            {Object.getOwnPropertyNames(item).map((rowItemName) => {
              ...
              return (
                <div key={`${uniqueID()}${item.id}`} className={`table__row-item${statusItemClass}`}>
              ...
              <div className="table__row-collapsed">
                <div className="table__row-collapsed-container">
                  ...
                  {item.services.map((service) => {
                    const currentService = serviceValues.find(
                      (serviceValue) => serviceValue.id === `${item.id}${service.id}`
                    );
                    return (
                      <div key={`${item.id}${service.id}`} className="table__row-collapsed-main">
                        <div className="table__row-collapsed-main-item">
                          ...
                          <div className="table__row-collapsed-main-item-el">
                            <Input
                              classes={`${
                                parseInt(currentService?.hrsDelivered) > parseInt(currentService?.packageHrs)
                          ...
                          <div className="table__row-collapsed-main-item-el">
                            <Input
                              classes={`${
                                parseInt(currentService?.actualVisits) === 0 ? 'table__row__wrong-input' : ''
                              }`}
