...
import EditElementDatePickers from './ModalComponents/EditElementDatePickers';
...
const CareChargesInfoEdited = ({ elements = [], hasEditStyle = true, onChangeInput, inputErrors = [] }) => {
  ...
  return (
    <>
      {elements.map(
        ({ name, property, value, startDate, claimedBy, endDate, period, dateFromWeeks, dateToWeeks, id }, index) => {
