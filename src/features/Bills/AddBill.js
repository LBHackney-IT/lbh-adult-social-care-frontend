...
import AddBillAttachedFiles from "./components/AddBillAttachedFiles";
import AddBillInvoiceDetails from "./components/AddBillInvoiceDetails";
import AddBillInvoiceFor from "./components/AddBillInvoiceFor";
...
const AddBill = () => {
  ...
  const addBill = () => {
    ...
    const { validFields, hasError } = inputValidator({ inputs: arrayInputs });
    if(hasError) {
