...
This is the frontend repo for HASC. To start the project please use the command _yarn dev_. This is the frontend repo of a web application, with the api repo being located [here](https://github.com/LBHackney-IT/lbh-adult-social-care-api).
