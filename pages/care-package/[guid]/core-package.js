...
import { mapPackageSchedulingOptions } from 'api/Mappers/optionsMapper';
...
const CorePackage = () => {
  ...
  const schema = yup.object().shape({
    ...
    primarySupportReasonId: yup.number().required().min(1, 'Please select a primary support reason'),
